...
1. Clone the repo
```sh
git clone https://github.com/jcstang/Word-Guess-Game.git
```
...
See the [open issues](https://github.com/jcstang/Word-Guess-Game/issues) for a list of proposed features (and known issues).
...
Project Link: [https://github.com/jcstang/Word-Guess-Game](https://github.com/jcstang/Word-Guess-Game)
